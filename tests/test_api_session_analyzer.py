...
class TestSessionAnalyzer:
    ...
    @pytest.mark.integration
    def test_analyze_session_creates_self_card_when_missing(self, test_client, sample_session, sample_client, mock_llm_success):
    ...
    @pytest.mark.integration
    def test_analyze_session_creates_character_card_from_updates(self, test_client, sample_session, sample_client, sample_self_card, monkeypatch):
        ...
        character_cards = db.get_character_cards(sample_client)
